 ...
 */
export function getStickyKey(guildId, channelId) {
    return `guild:${guildId}:sticky:${channelId}`;
}

/** Prefix used to list every sticky message row for a guild in degraded mode. */
export function getStickyGuildPrefix(guildId) {
